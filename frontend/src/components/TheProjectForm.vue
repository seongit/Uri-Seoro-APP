              ...
              <div class="row">
                  ...
                  <div class="col-sm-10 description-area">
                    <div class="form-control border-radius ">
                        ...
                        <!--에디터 기능 추후 구현 예정
                        <editor></editor> -->
                      <textarea v-model="resObj.description" class="form-control"  rows="10" style="resize:none; width:100%" ></textarea>
                    </div>
                  </div>
              </div>
    ...
    async onSubmitCreateProject(){
      ...
      if(this.formValidation()){
        ...
        if(this.$route.params.id){
          ...
          // 프로젝트 수정 
          apiProject.editProject(this.$route.params.id,requestProject).then((response)=>{
          ...
          // 프로젝트 생성
          apiProject.createProject(project).then((response) => {
